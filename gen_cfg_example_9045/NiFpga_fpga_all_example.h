 ...
 */
static const char* const NiFpga_fpga_all_example_Signature = "150C3373CD84CA379C0938748CB76276";
...
typedef enum
{
   ...
   NiFpga_fpga_all_example_IndicatorU64_fxp_AnalogOutput0_SCALER2 = 0x18178,
   NiFpga_fpga_all_example_IndicatorU64_fxp_AnalogOutput1_SCALER2 = 0x1817C,
   NiFpga_fpga_all_example_IndicatorU64_fxp_AnalogOutput2_SCALER2 = 0x18180,
   NiFpga_fpga_all_example_IndicatorU64_fxp_AnalogOutput3_SCALER2 = 0x18184,
...
typedef enum
{
   ...
   NiFpga_fpga_all_example_ControlU64_fxp_ShiftLeft_SCALER2 = 0x18174,
...
typedef enum
{
   ...
   NiFpga_fpga_all_example_IndicatorArrayU32Size_Counter_SCALER2 = 5,
...
typedef enum
{
   ...
   NiFpga_fpga_all_example_ControlArrayBoolSize_Gate_SCALER2 = 5,
...
typedef enum
{
   ...
   NiFpga_fpga_all_example_ControlArrayU32Size_PresetValues_SCALER2 = 5,
